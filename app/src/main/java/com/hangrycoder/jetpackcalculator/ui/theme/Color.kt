package com.hangrycoder.jetpackcalculator.ui.theme
...
val operationButtonBgSecondary = Color(0xFFD8CFC6)
val numberButtonBg = Color(0xFFF9F4EF)
val numberButtonBgSecondary = Color(0xFFE1DCD6)
val equalsButtonBg = Color(0xFFFBD54D)
val equalsButtonBgSecondary = Color(0xFFCFB041)
val buttonText = Color(0xFF121212)
val displayBg = Color(0xFF232723)
val displayBgSecondary = Color(0xFF7B857B)
